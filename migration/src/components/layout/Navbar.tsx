        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <nav id="navbar-desktop-nav" className="hidden lg:flex items-center gap-8">
              {navItems.map((item, index) => (
                <a
                  ...
                  id={`nav-item-${index}`}
                  href={item.href}
                  className="text-[15px] font-medium text-slate-300 hover:text-brand-green transition-colors duration-200 focus:outline-none relative py-1 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-brand-green after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-right"
                >
                  {item.label}
                </a>
              ))}
            ...
            <div id="navbar-actions" className="hidden sm:flex items-center gap-4">
              <a
                href="tel:92000000"
                className="flex items-center gap-2 text-slate-300 hover:text-brand-green transition-colors py-2 px-3 rounded-lg text-sm font-medium"
              >
